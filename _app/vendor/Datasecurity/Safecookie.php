<?php	
	...
	class Datasecurity_Safecookie implements Datasecurity_Safecookie_Interface
	{
		private $pass_key;
		...
		public function setCookie($cookie_name, $cookie_value, $seconds_alive = 1800, $path = '/')
		{
			...
			$ancrypt = new Datasecurity_Ancrypt($this->pass_key);
		...
		public static function set($cookie_details, $pass_key = null)
		{
			...
			{
				$safe_cookie = new Datasecurity_Ancrypt_Safecookie($pass_key);
